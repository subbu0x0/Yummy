...
public class Restaurant_act1 extends AppCompatActivity {
    String item,uname,price1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_restaurant_act1);
        ref = FirebaseDatabase.getInstance().getReference();
        b = (Button) findViewById(R.id.acart1);
        iname =  (TextView) findViewById(R.id.item_name1);
        rname = (TextView)findViewById(R.id.res_name1);
        price = (TextView)findViewById(R.id.item_price1);
